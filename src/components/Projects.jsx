...
const ProjectCard = ({
  ...
  return (
    ...
    >
      ...
      {active !== id ? (
        <div className="absolute inset-0 z-20 flex items-center justify-center overflow-hidden px-3 py-6">
          <h2
            className="font-extrabold font-beckman uppercase lg:w-[360px] sm:w-[320px] w-[280px]
            whitespace-normal break-words text-center sm:text-[20px] text-[14px] text-timberWolf tracking-[1px]
            lg:rotate-[-90deg] leading-[1.1]"
          >
            {name}
          </h2>
        </div>
        ...
        <>
          ...
          >
            ...
            <h2 className="font-bold sm:text-[28px] text-[20px] text-timberWolf uppercase font-beckman sm:mt-0 -mt-[1rem]">
              {name}
            </h2>

            <p className="text-silver sm:text-[12px] text-[12px] max-w-3xl sm:leading-[24px] leading-[18px] font-poppins tracking-[1px]">
              {description}
            </p>
  ...
  return (
    <div className="-mt-[6rem]">
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} `}>Stuff I always enjoy</p>
